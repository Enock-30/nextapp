export default function About(){
    return (
      ...
      <div className="relative isolate overflow-hidden bg-white-900 py-24 sm:py-32">
              <h2 className="text-5xl text-center text-green-900 underline mb-10">Shop with us for better experience</h2>
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-2xl lg:mx-0">
      <h2 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl text-center">Final Stock.
Up to 50% off.</h2>
    ...
    <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      ...
      <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col-reverse gap-1">
          ...
          <dd className="text-4xl font-semibold tracking-tight text-white">1.2 million</dd>
        </div>
        <div className="flex flex-col-reverse gap-1">
          <dt className="text-base/7 text-gray-300">Available support center</dt>
          <dd className="text-4xl font-semibold tracking-tight text-white">24/7</dd>
        </div>
        <div className="flex flex-col-reverse gap-1">
          <dt className="text-base/7 text-gray-300">monday - sunday</dt>
          <dd className="text-4xl font-semibold tracking-tight text-white">24/7</dd>
        </div>
        <div className="flex flex-col-reverse gap-1">
          <dt className="text-base/7 text-gray-300">Discounts</dt>
